...
<div class="login-section">
	...
	<div class="login-inner">
		<h1><a href="http://test.hackers.com/member/index.php"><img src="http://img.hackershrd.com/common/logo.png" alt="해커스 HRD LOGO" width="142" height="31"/></a></h1>
		<div class="box-login">
			<form id="lForm" action="session.php" method="POST" onsubmit="return login();">
			<div class="login-input">
				<div class="input-text-box">
					<input type="text" name="id" class="input-text mb5" placeholder="아이디" style="width:190px"/>
					<input type="password" name="pw" class="input-text" placeholder="비밀번호" style="width:190px"/>
				</div>
				<button id="ck" type="submit" class="btn-login">로그인</button>
			</div>
			</form>
			<div class="login-chk">
			...
			<div class="box-btn">
				<a href="http://test.hackers.com/member/index.php?mode=step_01" class="btn-m-gray">회원가입</a>
				<a href="http://test.hackers.com/member/index.php?mode=find_id" class="btn-m-gray">ID/PW 찾기</a>
			</div>
		</div>
