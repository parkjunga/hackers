...
2010년 4월 23일부터 시행되던 종전의 약관은 본 약관으로 대체됩니다. 
					...
					<div class="mt10">
						<label class="input-sp">
							<input type="checkbox" class="selectCheck" name="check1"/>
...
*이전 개인정보취급방침 보기(2014년 2월 1일부터 시행된 방침) 
					...
					<div class="mt10">
						<label class="input-sp">
							<input type="checkbox" class="selectCheck" name="check2"/>
							<span class="input-txt">약관에 동의합니다.</span>
						</label>
					</div>
				</div>
...
$(function(){
    $("#nextJoin").click(function(){
		var chkVal = $('input:checkbox[name="check1"]').is(":checked");
		var chkVal2 = $('input:checkbox[name="check2"]').is(":checked");
		if(!chkVal){
			alert("이용약관에 동의해주세요");
			return false;
		}
...
// 전체 동의 여부 체크 
 $(function(){
    $("input[name='checkAll']").click(function(){
        ...
        if(chk) $(".selectCheck").prop('checked',true);
        else $(".selectCheck").prop('checked',false);
    });
 })
</script>
